...
logger = setup_logger("clean_order_payments.py")

BASE_DIR = Path(__file__).resolve().parent.parent.parent
OUTPUT_DIR = BASE_DIR / "data/clean_json_files"

file_name = "olist_order_payments_dataset.json"
